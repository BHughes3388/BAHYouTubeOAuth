...
// BAHYouTubeOAuth
#define COCOAPODS_POD_AVAILABLE_BAHYouTubeOAuth
#define COCOAPODS_VERSION_MAJOR_BAHYouTubeOAuth 0
#define COCOAPODS_VERSION_MINOR_BAHYouTubeOAuth 1
#define COCOAPODS_VERSION_PATCH_BAHYouTubeOAuth 0
